...
class LinkSentinel_Plugin {
	...
	public static function uninstall() {
		...
		// phpcs:enable
		foreach ( array( 'linksentinel_settings', 'linksentinel_scan', 'linksentinel_db_version', 'linksentinel_pro_db_version', 'linksentinel_last_notified_scan', 'linksentinel_last_webhook_scan', 'linksentinel_qppr_import' ) as $option ) {
